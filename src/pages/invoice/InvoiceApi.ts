...
async function deleteInvoice(invoiceId: number): Promise<Invoice | undefined> {
  return (await axiosClient.delete(`/invoices/${invoiceId}`)).data;
}

export { fetchInvoice, fetchAllInvoices, createInvoice, deleteInvoice };
